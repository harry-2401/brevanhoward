    ...
    mainData: [
      {
        id: "detailedRemark1",
        icon:
          <svg width="22" height="16" viewBox="0 0 22 16" fill="none"><path d="M15.6699 9.12891C17.0399 10.0589 17.9999 11.3189 17.9999 12.9989V15.9989H21.9999V12.9989C21.9999 10.8189 18.4299 9.52891 15.6699 9.12891Z" fill="white"></path><path d="M13.9999 8C16.2099 8 17.9999 6.21 17.9999 4C17.9999 1.79 16.2099 0 13.9999 0C13.5299 0 13.0899 0.0999998 12.6699 0.24C13.4999 1.27 13.9999 2.58 13.9999 4C13.9999 5.42 13.4999 6.73 12.6699 7.76C13.0899 7.9 13.5299 8 13.9999 8Z" fill="white"></path><path d="M8 8C10.21 8 12 6.21 12 4C12 1.79 10.21 0 8 0C5.79 0 4 1.79 4 4C4 6.21 5.79 8 8 8ZM8 2C9.1 2 10 2.9 10 4C10 5.1 9.1 6 8 6C6.9 6 6 5.1 6 4C6 2.9 6.9 2 8 2Z" fill="white"></path><path d="M8 9C5.33 9 0 10.34 0 13V16H16V13C16 10.34 10.67 9 8 9ZM14 14H2V13.01C2.2 12.29 5.3 11 8 11C10.7 11 13.8 12.29 14 13V14Z" fill="white"></path></svg>,
      ...
      },
      {
        id: "detailedRemark2",
        icon:
          <svg width="24" height="16" viewBox="0 0 24 16" fill="none"><path d="M4 2H22V0H4C2.9 0 2 0.9 2 2V13H0V16H14V13H4V2ZM23 4H17C16.45 4 16 4.45 16 5V15C16 15.55 16.45 16 17 16H23C23.55 16 24 15.55 24 15V5C24 4.45 23.55 4 23 4ZM22 13H18V6H22V13Z" fill="white"></path></svg>,
      ...
      },
      {
        id: "detailedRemark3",
        icon:
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none"><path d="M5.55553 12.2539H2.6543V17.2459H5.55553V12.2539Z" fill="white"></path><path d="M9.41393 9.24609H6.5127V17.2461H9.41393V9.24609Z" fill="white"></path><path d="M13.2714 9.24609H10.3701V17.2461H13.2714V9.24609Z" fill="white"></path><path d="M17.1297 6.23828H14.2285V17.2463H17.1297V6.23828Z" fill="white"></path><path d="M20 18.4961H0V20.0001H20V18.4961Z" fill="white"></path><path d="M8.02437 6.752H11.8824L15.0614 3.456L16.1725 4.608L17.3454 0L12.9009 1.248L14.012 2.4L11.2651 5.248H7.40708L3.33301 9.472L4.38239 10.528L8.02437 6.752Z" fill="white"></path></svg>,
      ...
      },
      {
        id: "detailedRemark4",
        icon:
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none"><path d="M22 5V7H19V10H17V7H14V5H17V2H19V5H22ZM19 19H5V5H11V3H5C3.9 3 3 3.9 3 5V19C3 20.1 3.9 21 5 21H19C20.1 21 21 20.1 21 19V13H19V19ZM15 13V17H17V13H15ZM11 17H13V9H11V17ZM9 17V11H7V17H9Z" fill="white"></path></svg>,
      ...
      },
      {
        id: "detailedRemark6",
        icon:
          <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><path d="M12.5 11H11.71L11.43 10.73C12.41 9.59 13 8.11 13 6.5C13 2.91 10.09 0 6.5 0C2.91 0 0 2.91 0 6.5C0 10.09 2.91 13 6.5 13C8.11 13 9.59 12.41 10.73 11.43L11 11.71V12.5L16 17.49L17.49 16L12.5 11ZM6.5 11C4.01 11 2 8.99 2 6.5C2 4.01 4.01 2 6.5 2C8.99 2 11 4.01 11 6.5C11 8.99 8.99 11 6.5 11Z" fill="white"></path></svg>,
